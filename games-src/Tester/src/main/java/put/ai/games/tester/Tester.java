...
public class Tester {
    ...
    private static final Pattern namePattern = Pattern.compile("^\\p{IsLetter}+ (\\p{IsLetter}|-)+ \\d{5,6}( \\p{IsLetter}+ (\\p{IsLetter}|-)+ \\d{5,6})?$");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.printf("Nie znalzezion klasy gracza: %s\n", ex);
            System.exit(1);
        }
        ...
        try {
            ...
            if (!isValidName(name)) {
                System.out.println("Nazwa gracza nie pasuje do wzorca: Imie1 Nazwisko1 Indeks1 Imie2 Nazwisko2 Indeks2");
                System.exit(1);
            }
