...
public class BoardViewPanel extends JPanel {
    ...
    private Image scaledWhite, scaledBlack;
    ...
    private enum Direction {
        ...
        UNDEFINED, NORTH, SOUTH, WEST, EAST
    };

    public BoardViewPanel() {
        try {
            //InputStream stream = BoardViewPanel.class.getResourceAsStream("/put/ai/snort/snortgui/images/white.png");
            InputStream stream = BoardViewPanel.class.getResourceAsStream("/put/ai/snort/snortgui/images/aries-red.png");
    ...
    private int getSide() {
        return Math.min(this.getWidth(), this.getHeight()) / board.getSize();
    }
    ...
    private class TranslatingMouseListener implements MouseListener {
        ...
        private MouseEvent translate(MouseEvent e) {
            ...
            e = new MouseEvent((Component) e.getSource(), e.getID(), e.getWhen(), e.getModifiers(), e.getX(), e.getY(), e.getXOnScreen(), e.getYOnScreen(), e.getClickCount(), e.isPopupTrigger(), e.getButton());
