...
public class AriesBoardTest
{
    ...
    {
        BoardState state = BoardStateBuilder.startFromEmpty(8)
            .setField(3, 1, Color.PLAYER1)
            .setField(3, 3, Color.PLAYER2)
            .setField(3, 4, Color.PLAYER2)
            .setField(3, 5, Color.PLAYER2)
            .finish();
    ...
    {
        BoardState state = BoardStateBuilder.startFromEmpty(8)
            .setField(3, 1, Color.PLAYER2)
            .setField(3, 2, Color.PLAYER2)
            .setField(3, 3, Color.PLAYER2)
            .finish();
    ...
    public void player1MovesToEmptyField()
    {
        BoardState state = BoardStateBuilder.startFromEmpty(8)
            .setField(3, 1, Color.PLAYER1)
            .setField(4, 1, Color.PLAYER1)
            .setField(5, 1, Color.PLAYER1)
            .setField(3, 4, Color.PLAYER2)
            .setField(3, 5, Color.PLAYER2)
            .finish();
        ...
        for (Move m : possibleMoves)
        {
            ...
            if (am.getColor() == Color.PLAYER1 && am.getSrcX() == 3 && am.getSrcY() == 1 && am.getDstX() == 3 && am.getDstY() == 3)
            {
                chosenMove = am;
            }
        }
    ...
    public void player1MovesToFirstEnemyField()
    {
        ...
        {
            AriesMove am = (AriesMove) m;
            if (am.getColor() == Color.PLAYER1 && am.getSrcX() == 3 && am.getSrcY() == 1 && am.getDstX() == 3 && am.getDstY() == 4)
            {
                chosenMove = am;
            }
        }
    ...
    public void player2GetsPushedOffTheBoard()
    {
        BoardState state = BoardStateBuilder.startFromEmpty(8)
            ...
            .setField(3, 4, Color.PLAYER2)
            .setField(3, 5, Color.PLAYER2)
            .setField(3, 6, Color.PLAYER2)
            .setField(3, 7, Color.PLAYER2)
            .finish();
    ...
    {
        BoardState state = BoardStateBuilder.startFromEmpty(8)
            .setField(0, 7, Color.PLAYER2)
            .setField(1, 7, Color.PLAYER1)
            .setField(2, 7, Color.PLAYER2)
            .finish();
        ...
        {
            AriesMove am = (AriesMove) m;
            if (am.getColor() == Color.PLAYER1 && am.getSrcX() == 1 && am.getSrcY() == 7 && am.getDstX() == 0 && am.getDstY() == 7)
            {
                chosenMove = am;
            }
        }
    ...
    */
    ...
    public void avoidingStateRepetition()
    {
        ...
        {
            AriesMove am = (AriesMove) m;
            if (am.getColor() == Color.PLAYER2 && am.getSrcX() == 3 && am.getSrcY() == 5 && am.getDstX() == 3 && am.getDstY() == 6)
            {
                chosenMove = am;
            }
        }
