...
public class JarPlayerLoader extends AbstractPlayerLoader {
    ...
    private String getPlayerClassName(URL url) throws MalformedURLException, IOException {
    ...
    @Override
    public Class<? extends Player> load(String jarFile) throws PlayerLoadingException {
        try {
